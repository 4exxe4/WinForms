...
namespace Clock
{
    public partial class MainForm : System.Windows.Forms.Form
    {
        ...
        private void tsmiShowControls_CheckedChanged(object sender, EventArgs e)
        {
            ...
            //Если на элемент окна (Control) воздействуют при помощи клавиатуры или мыши, а этот Control отправляет событие своему родителю, а родитель может обрабатывать или не обрабатывать это событие.
        }
        ...
        private void tsmiAutoStart_CheckedChanged(object sender, EventArgs e)
        {
            ...
            else rk.DeleteValue(key_name, false); //false - не бросать исключения, если данная запись отсутствует в реестре.
            rk.Dispose();
        }
